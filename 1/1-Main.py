...
#----------------------------
def selbst_negativliste(personenliste, hate_list):
...
selbst_negativliste(personenliste, hate_list)
...
while minus == True:
    ...
    if len(hate_list[l]) != 0:
        ...
        for x in range(0, len(zimmerliste)):
            ...
            if beitritt == True:
                ...
                zimmernegativliste[x] = zimmer_negativliste(index, zimmernegativ, hate_list)
                del personenliste[l]
                del hate_list[l]
    ...
    #Person hat niemanden in ihrer like_list und das Ende der Personenlite ist erreicht
    elif (len(like_list[l]) == 0) and (l == (len(personenliste)-1)):
        minus = False
    #Keine Personen in like_list und noch kein Ende der Liste --> Erhöhung der
    #Iterationsvariablen um 1
    else:
